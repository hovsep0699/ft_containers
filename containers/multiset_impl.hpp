...
namespace ft
{
	...
	template< typename _K,
		typename _Compare,
		typename _Allocator >
	typename multiset<_K, _Compare, _Allocator>::iterator multiset<_K, _Compare, _Allocator>::insert(const value_type& value)
	{
	...
	{
		return _tree.insert(tree_type::s_const_cast(pos), value);
	}
	...
	{
		return _tree.erase(tree_type::s_const_cast(pos));
	}
	...
	{
		return _tree.erase(tree_type::s_const_cast(first), tree_type::s_const_cast(last) );
	}
